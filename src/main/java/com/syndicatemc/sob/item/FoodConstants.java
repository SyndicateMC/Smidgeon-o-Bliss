...
public class FoodConstants {
    ...
    public static final FoodProperties PRICKLY_PEAR = (new FoodProperties.Builder())
            ...
            .build();
    public static final FoodProperties GOLDEN_PRICKLY_PEAR = (new FoodProperties.Builder())
            .nutrition(5)
            .saturationMod(0.45F)
            .effect(() -> new MobEffectInstance(SOBMobEffects.SPITE.get(), 600, 2), 1.0F)
            .build();
    ...
    public static final FoodProperties ICHORFRUIT = (new FoodProperties.Builder())
            ...
            .saturationMod(0.55F)
            .build();
    public static final FoodProperties ECHO_ROCK_CANDY = (new FoodProperties.Builder())
            .nutrition(1)
            .saturationMod(0.1F)
            .alwaysEat()
            .build();
    public static final FoodProperties ROASTED_PEANUTS = (new FoodProperties.Builder())
            ...
            .saturationMod(0.1F)
            .fast()
            .effect(() -> new MobEffectInstance(SOBMobEffects.TOUGHNESS.get(), 900, 0), 1.0F)
            .build();
    public static final FoodProperties PBNJ = (new FoodProperties.Builder())
            .nutrition(10)
            .saturationMod(0.75F)
            .effect(() -> new MobEffectInstance(SOBMobEffects.TOUGHNESS.get(), 3600, 0), 1.0F)
            .build();
    public static final FoodProperties DRIED_BERRIES = (new FoodProperties.Builder())
            .nutrition(3)
            .saturationMod(0.5F)
            .fast()
            .build();
    public static final FoodProperties ANTS_LOG = (new FoodProperties.Builder())
            .nutrition(6)
            .saturationMod(0.6F)
    ...
    public static final FoodProperties CANDIED_PEANUTS = (new FoodProperties.Builder())
            ...
            .effect(() -> new MobEffectInstance(SOBMobEffects.TOUGHNESS.get(), 4800, 0), 1.0F)
            .build();
    ...
    public static final FoodProperties ROOT_STEAK = (new FoodProperties.Builder())
            ...
            .build();
    public static final FoodProperties CACTUS_PORKCHOP = (new FoodProperties.Builder())
            .nutrition(12)
            .saturationMod(0.65F)
            .effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), 3000, 0), 1.0F)
            .effect(() -> new MobEffectInstance(SOBMobEffects.SPITE.get(), 600, 0), 1.0F)
            .build();
    //req: ENVI
    ...
    public static final FoodProperties FISH_FRY = (new FoodProperties.Builder())
            ...
            .build();
    //req: MD
    public static final FoodProperties ROOT_SALAD = (new FoodProperties.Builder())
            .nutrition(7)
            .saturationMod(0.30F)
    ...
    public static final FoodProperties DEATH_DRINK = (new FoodProperties.Builder())
            ...
            .alwaysEat()
            .build();
    public static final FoodProperties PRICKLY_MELOMEL = (new FoodProperties.Builder())
    ...
    public static final FoodProperties PALE_DAIQUIRI = (new FoodProperties.Builder())
            ...
            .build();
    //req: ATMO
    public static final FoodProperties PORTAL_DRINK = (new FoodProperties.Builder())
